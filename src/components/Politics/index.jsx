  ...
  return (
    <>
      <div className="w-full max-w-[800px] min-height flex flex-col justify-center items-center overflow-scroll">
        <div className="w-full min-height px-2 py-4">
          <p className="text-sm text-white text-center">
              Esta política é válida a partir de Sep 2022. Política de Privacidade - Performance Control
          </p>
          <p className="text-sm text-white text-justify mt-5">
              Performance Control, pessoa jurídica de direito privado leva a sua privacidade a sério e zela pela segurança e proteção de dados de todos os seus clientes, parceiros, fornecedores e usuários do site domínio https://performancecontrol.site e qualquer outro site, site ou aplicativo operado pelo lojista.
          </p>
          ...
          <p className="text-sm text-white text-justify mt-2">
              AO ACESSAR A site, ENVIAR COMUNICAÇÕES OU FORNECER QUALQUER TIPO DE DADO PESSOAL, VOCÊ DECLARA ESTAR CIENTE COM RELAÇÃO AOS TERMOS AQUI PREVISTOS E DE ACORDO COM A POLÍTICA DE PRIVACIDADE, A QUAL DESCREVE AS FINALIDADES E FORMAS DE TRATAMENTO DE SEUS DADOS PESSOAIS QUE VOCÊ DISPONIBILIZAR NA site.
          <p/>
          <p className="text-sm text-white text-justify mt-2">
              Esta Política de Privacidade fornece uma visão geral de nossas práticas de privacidade e das escolhas que você pode fazer, bem como direitos que você pode exercer em relação aos Dados Pessoais tratados por nós. Se você tiver alguma dúvida sobre o uso de Dados Pessoais, entre em contato com levoninformationtechnology@gmail.com.
          </p>
          <p className="text-sm text-white text-justify mt-2">
          ...
          <p className="text-sm text-white text-justify mt-2">
              Seção 1 - Definições Para os fins desta Política de Privacidade:
          </p>
          <p className="text-sm text-white text-justify mt-2">
          ...
          <p className="text-sm text-white text-justify mt-2">
              ...
              Coletamos e usamos Dados Pessoais para gerenciar seu relacionamento conosco e melhor atendê-lo quando você estiver adquirindo produtos e/ou serviços na site, personalizando e melhorando sua experiência. Exemplos de como usamos os dados incluem:

              Viabilizar que você adquira produtos e/ou serviços na site;
              ...
              Para personalizar sua experiência de uso da site;
          ...
          <p className="text-sm text-white text-justify mt-2">
              ...
              O público em geral poderá navegar na site sem necessidade de qualquer cadastro e envio de Dados Pessoais. No entanto, algumas das funcionalidades da site poderão depender de cadastro e envio de Dados Pessoais como concluir a compra/contratação do serviço e/ou a viabilizar a entrega do produto/prestação do serviço por nós.

              No contato a site, nós podemos coletar:
              ...
              Na navegação geral na site, nós poderemos coletar:

              Dados de localização: dados de geolocalização quando você acessa a site;
          ...
          <p className="text-sm text-white text-justify mt-2">
              ...
              Com terceiros, com o objetivo de nos ajudar a gerenciar a site;
          ...
          <p className="text-sm text-white text-justify mt-2">
              ...
              Quando você visita a site, ela pode armazenar ou recuperar informações em seu navegador, principalmente na forma de cookies, que são arquivos de texto contendo pequenas quantidades de informação. Essas informações podem ser sobre você, suas preferências ou seu dispositivo e são usadas principalmente para que a site funcione como você espera. As informações geralmente não o identificam diretamente, mas podem oferecer uma experiência na internet mais personalizada.
              ...
              Por meio do navegador ou do dispositivo: algumas informações são coletadas pela maior parte dos navegadores ou automaticamente por meio de dispositivos de acesso à internet, como o tipo de computador, resolução da tela, nome e versão do sistema operacional, modelo e fabricante do dispositivo, idioma, tipo e versão do navegador de Internet que está utilizando. Podemos utilizar essas informações para assegurar que a site funcione adequadamente.
              Uso de cookies: informações sobre o seu uso da site podem ser coletadas por terceiros a partir de cookies. Cookies são informações armazenadas diretamente no computador que você está utilizando. Os cookies permitem a coleta de informações tais como o tipo de navegador, o tempo despendido na site, as páginas visitadas, as preferências de idioma, e outros dados de tráfego anônimos. Nós e nossos prestadores de serviços utilizamos informações para proteção de segurança, para facilitar a navegação, exibir informações de modo mais eficiente, e personalizar sua experiência ao utilizar a site, assim como para rastreamento online. Também coletamos informações estatísticas sobre o uso da site para aprimoramento contínuo do nosso design e funcionalidade, para entender como a site é utilizada e para auxiliá-lo a solucionar questões relativas à site.
              ...
              As definições que escolher podem afetar a sua experiência de navegação e o funcionamento que exige a utilização de cookies. Neste sentido, rejeitamos qualquer responsabilidade pelas consequências resultantes do funcionamento limitado da site provocado pela desativação de cookies no seu dispositivo (incapacidade de definir ou ler um cookie).
              Uso de pixel tags e outras tecnologias similares: pixel tags (também conhecidos como Web beacons e GIFs invisíveis) podem ser utilizados para rastrear ações de usuários da site (incluindo destinatários de e-mails), medir o sucesso das nossas campanhas de marketing e coletar dados estatísticos sobre o uso da site e taxas de resposta, e ainda para outros fins não especificados. Podemos contratar empresas de publicidade comportamental, para obter relatórios sobre os anúncios da site em toda a internet. Para isso, essas empresas utilizam cookies, pixel tags e outras tecnologias para coletar informações sobre a sua utilização, ou sobre a utilização de outros usuários, da nossa site e de site de terceiros. Nós não somos responsáveis por pixel tags, cookies e outras tecnologias similares utilizadas por terceiros.
          </p>
          <p className="text-sm text-white text-justify mt-2">
              Seção 8 - Categorias de cookies
              Os cookies utilizados na nossa site estão de acordo com os requisitos legais e são enquadrados nas seguintes categorias:
              ...
              Publicidade: utilizamos cookies com o objetivo de criar campanhas segmentadas e entregar anúncios de acordo com o seu perfil de consumo na nossa site virtual.
          </p>
          <p className="text-sm text-white text-justify mt-2">
          ...
          <p className="text-sm text-white text-justify mt-2">
              ...
              Caso pretenda exercer qualquer um dos direitos previstos, inclusive retirar o seu consentimento, nesta Política de Privacidade e/ou nas Leis de Proteção de Dados, ou resolver quaisquer dúvidas relacionadas ao Tratamento de seus Dados Pessoais, favor contatar-nos em levoninformationtechnology@gmail.com.
           </p>
          </p>
        </div>
      </div> 
